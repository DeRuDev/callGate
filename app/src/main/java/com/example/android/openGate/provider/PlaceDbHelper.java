package com.example.android.openGate.provider;
...
import com.example.android.openGate.provider.PlaceContract.PlaceEntry;
...
public class PlaceDbHelper extends SQLiteOpenHelper {
    ...
    // The database name
    private static final String DATABASE_NAME = "openGate.db";
